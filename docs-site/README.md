...
It was designed to be lifted out of the Valence Drive firmware repository into
...
that parse a live device's catalog — those stay in Valence Drive by design
...
`.github/workflows/docs.yml` did not live under this prefix in Valence Drive,
