// test_valence_blobdone -- RFC-050: the §8.4 backpressure decision table and
// the BLOB_DONE completion signal.
//
// The field symptom this suite exists for (Valence Drive sd-3qu): a watch
...
// the same shape as test_valence_session / test_valence_readygate. The one
